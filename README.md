...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/geojson-rewind-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14171&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/geojson-rewind-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `geojson-rewind` can be installed with:

```
conda install geojson-rewind
```

It is possible to list all of the versions of `geojson-rewind` available on your platform with:
